...
import { type AnyMapLibreGlDirectionsEvent, MapLibreGlDirectionsEvented } from "./events";
...
export default class MapLibreGlDirections extends MapLibreGlDirectionsEvented {
    ...
    protected fetchDirections(originalEvent: AnyMapLibreGlDirectionsEvent): Promise<void>;
    ...
    protected onDragUp(e: MapMouseEvent | MapTouchEvent): void;
